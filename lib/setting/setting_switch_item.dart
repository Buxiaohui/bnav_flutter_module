...
class SwitchItemWidget extends StatefulWidget {
  ...
  SwitchItemWidget.init(this.switchItem);
  ...
  factory SwitchItemWidget.forDesignTime() {
    ...
    switchItem.imagePathCheckIn = "assets/images/nsdk_set_checkin_icon.png";
    switchItem.imagePathCheckOut = "assets/images/nsdk_set_checkout_icon.png";
    switchItem.checkIn = true;
    switchItem.itemHeight = 90;
    switchItem.mainTitleTextColor = Colors.blue;
    return SwitchItemWidget.init(switchItem);
  }
...
class _SwitchItemWidgetState extends State<SwitchItemWidget> {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      home: getSwitchWitchWidget(widget.switchItem),
    );
  }
}

Widget getSwitchWitchWidget(SwitchItem switchItem) {
  ...
  SwitchItemClickCallback onCallback = switchItem.voidCallback;
...
class SwitchItem {
  ...
  bool checkIn;
  double itemHeight;
  SwitchItemClickCallback voidCallback;
}

void main() => runApp(SwitchItemWidget());
